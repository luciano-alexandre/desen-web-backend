...
Antes de iniciar DTOs e validação, organize o versionamento do projeto NestJS evoluído até a correção do encontro 09.
...
- conta no GitHub;
- projeto NestJS local já funcionando (ex.: `api-encontro-09`);
...
Nos encontros 06 e 07, a turma estruturou rotas, parâmetros e query strings. Nos encontros 08 e 09, realizou e corrigiu a atividade avaliativa. Agora surge um problema central de backend real: confiar cegamente nos dados enviados pelo cliente.
...
### Fluxo rápido de uso no encontro 10
